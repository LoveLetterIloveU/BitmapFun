...
import com.lee.bitmapfun.cache.ImageCache;
import com.lee.bitmapfun.cache.ImageResizer;
import com.lee.bitmapfun.cache.ImageCache.ImageCacheParams;

/**
 * This class is a view to display images from SD Card.
 * 
 * @author Li Hong
 *
 * @date 2011/08/24
...
public class TosImageViewer extends GridView
{
    ...
    private void initialize(Context context)
    {
        ...
        m_imageSearcher.setThumbnailSize(140, 140);
        ...
        m_imageWorker = new ImageResizer(context, 140);
        //m_imageWorker.setLoadingImage(android.R.drawable.picture_frame);
        m_imageWorker.setImageSize(140, 140);
        m_imageWorker.setImageSearcher(m_imageSearcher);
        m_imageWorker.setImageFadeIn(true);
        
        ImageCacheParams cacheParams = new ImageCacheParams(context, "Image_cache_param");
